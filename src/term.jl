...
# MA.operate_to!(::Term, ::typeof(*), ...), MA.operate!(*, ...) and
# MA.operate!(one, ...) are defined by downstream packages (e.g.,
# MultivariatePolynomials) which provide polynomial-specific implementations.
